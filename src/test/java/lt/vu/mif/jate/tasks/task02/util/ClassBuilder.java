package lt.vu.mif.jate.tasks.task02.util;
...
public class ClassBuilder {
    ...
    /**
     * Set interfaces to the class
     *
     * @param ifaceClass fully qualified class name
     * @return
     * @throws NotFoundException
     * @throws CannotCompileException
     */
    public ClassBuilder setInterface(Class<?> ifaceClass) throws NotFoundException, CannotCompileException {
        cc.addInterface(pool.getCtClass(ifaceClass.getName()));
        return this;
    }
    ...
    public AnnBuilder<ClassBuilder> newAnnotation(Class<? extends java.lang.annotation.Annotation> type) {
        return new AnnBuilder<>(type, this, attrs, this);
    }
    ...
    */
    public class PropertyBuilder {
        ...
        public AnnBuilder<PropertyBuilder> newFieldAnnotation(Class<? extends java.lang.annotation.Annotation> type) {
            return new AnnBuilder<>(type, cb, af, this);
        }
        ...
        public AnnBuilder<PropertyBuilder> newGetterAnnotation(Class<? extends java.lang.annotation.Annotation> type) {
            return new AnnBuilder<>(type, cb, ag, this);
        }
        ...
        public AnnBuilder<PropertyBuilder> newSetterAnnotation(Class<? extends java.lang.annotation.Annotation> type) {
            return new AnnBuilder<>(type, cb, as, this);
        }
    }
